  ...
  if (isEvaluating) {
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center text-center p-8">
        ...
        <h2 className="text-3xl font-black text-slate-800 mb-4">AI is Evaluating Your Essay...</h2>
        <p className="text-slate-500 text-lg max-w-md">Gemini is currently analyzing your vocabulary, grammar, coherence, and task achievement to calculate your official IELTS Band Score.</p>
      </div>
    );
  }
